...
export class ModulesController {
   ...
   * Inyecta el servicio ModulesService.
   ...
   * @returns Una promesa que resuelve con el objeto Module si es encontrado o RpcException(codigo 404) si no se encuentra.
   */
   ...
   * @returns Una promesa que resuelve con el objeto ProcedureType si es encontrado o RpcException si no se encuentra.
   */
   ...
   * @returns Una promesa que resuelve con el objeto ProcedureModality si es encontrado o RpcException si no se encuentra.
   */
   ...
   * Utiliza el servicio para buscar una entidad (Módulo, Tipo de Trámite o Modalidad de Trámite) por ID y carga relaciones especificadas.
