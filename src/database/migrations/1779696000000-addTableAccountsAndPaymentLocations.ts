  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`
      ...
      VALUES
        ...
        (2, 'BANCO SOLIDARIO S.A.', 'BSO', true, 'MLD1017', ${LOCAL_TIMESTAMP}, ${LOCAL_TIMESTAMP}),
        (3, 'BANCO NACIONAL DE BOLIVIA S.A.', 'BNB', true, 'MLD1001', ${LOCAL_TIMESTAMP}, ${LOCAL_TIMESTAMP}),
        (4, 'BANCO BISA S.A.', 'BIS', true, 'MLD1009', ${LOCAL_TIMESTAMP}, ${LOCAL_TIMESTAMP}),
        (5, 'BANCO DE CRÉDITO DE BOLIVIA S.A.', 'BCR', true, 'MLD1005', ${LOCAL_TIMESTAMP}, ${LOCAL_TIMESTAMP}),
        (6, 'BANCO FORTALEZA S.A.', 'BFO', true, 'MLD1034', ${LOCAL_TIMESTAMP}, ${LOCAL_TIMESTAMP}),
        (7, 'BANCO GANADERO S.A.', 'BGA', true, 'MLD1018', ${LOCAL_TIMESTAMP}, ${LOCAL_TIMESTAMP}),
        (8, 'BANCO MERCANTIL SANTA CRUZ S.A.', 'BME', true, 'MLD1003', ${LOCAL_TIMESTAMP}, ${LOCAL_TIMESTAMP}),
        (9, 'MUTUAL DE SERVICIOS AL POLICÍA', 'MUS', true, null, ${LOCAL_TIMESTAMP}, ${LOCAL_TIMESTAMP}),
        (10, 'BANCO ECONOMICO S.A.', 'BEC', true, 'MLD1016', ${LOCAL_TIMESTAMP}, ${LOCAL_TIMESTAMP}),
        ...
        (13, 'BANCO FIE (BANCO PARA EL FOMENTO A INICIATIVAS ECONÓMICAS S.A.)', 'BIE', true, 'MLD1033', ${LOCAL_TIMESTAMP}, ${LOCAL_TIMESTAMP}),
        (14, 'BANCO PYME ECOFUTURO S.A.', 'PEF', true, 'MLD74002', ${LOCAL_TIMESTAMP}, ${LOCAL_TIMESTAMP})
